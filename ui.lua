-- // Moonveil-HUB UI Library (Core Engine) - Optimized for Zero Lag Loops
-- // Remade by gaeuly
...
function Library:CreateWindow(options)
    local hubName = "Moonveil-HUB"
    local subText = "Made by gaeuly"
    local subColor = AccentColor
    local sphTextToggle = false
    local sphWords = "Moonveil-HUB"
    local sphImage = nil
    ...
    local PopupText = Create("TextLabel", {Parent = PopupCard, Text = "Are you sure you want to close Moonveil-HUB? Unsaved configurations might be lost.", Font = Enum.Font.Gotham, TextSize = 13, TextColor3 = SubTextColor, BackgroundTransparency = 1, Size = UDim2.new(1, -40, 0, 40), Position = UDim2.new(0, 20, 0, 55), ZIndex = 102, TextTransparency = 1, TextXAlignment = Enum.TextXAlignment.Center, TextWrapped = true})
        ...
        function TabConfig:CreatePage(pageName)
            ...
            function PageObj:CreateSection(sectionName)
                ...
                function Elements:AddConfigManager(folderName)
                    folderName = folderName or "Moonveil-HUB"
